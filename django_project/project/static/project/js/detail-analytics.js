...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchAnalysisData(filters = {}) {
        ...
        const url  = `/project/api/detail-analytics/${siteSlug}${queryString ? `?${queryString}` : ''}`;
    ...
    // TIme series station performance plot
    ...
    // Azimuthal Gap Initial Histogram
    ...
    function updateUI(data) {
        if (!data || !data.time_series_performance|| !data.wadati_profile || !data.hypocenter) {
